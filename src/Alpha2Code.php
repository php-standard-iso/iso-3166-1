...
interface Alpha2Code
{
    ...
    public const LAO_PEOPLE_S_DEMOCRATIC_REPUBLIC_THE         = 'LA';
    ...
    public const UNITED_SATES_OF_AMERICA_THE                              = 'US';
